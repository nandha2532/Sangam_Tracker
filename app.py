...
# ==========================================
# 4. SIDEBAR & NAVIGATION (Reorganized)
# ==========================================
...
nav_selection = st.sidebar.radio("", available_pages, label_visibility="collapsed")

st.sidebar.divider()

# --- MIDDLE: Date Selector ---
st.sidebar.markdown("### 📅 Select Date")
global_target_date = st.sidebar.date_input("", datetime.today(), label_visibility="collapsed")

# --- BOTTOM: User Profile & Logout ---
# Add vertical spacing to push the profile section to the bottom of the screen
